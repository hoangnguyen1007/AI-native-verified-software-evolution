...
| build.problems | 12 |
| capabilityGaps | 92 |
| classpath.artifacts | 418 |
| classpath.problems | 165 |
| decoding.decoded | 50 |
...
| build.configuration:UNSUPPORTED_PROFILE_ACTIVATION | 18 |
| build.dependency:DEPENDENCY_CYCLE | 1 |
| build.dependency:MISSING_ARTIFACT | 27 |
...
| build.pom:MISSING_POM | 27 |
| build.pom:POM_MODEL_WARNING | 5 |
