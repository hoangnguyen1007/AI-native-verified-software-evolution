...
**PROVISIONAL implementation baseline, 2026-09-02.** JavaParser + SymbolSolver is human-approved. The human subsequently instructed Codex to settle the sufficiently mature M2 contracts and proceed to production vertical slices. This authorizes implementation using D1–D3 below; empirical correctness and G2 remain unproven. Work is currently paused by request; see the [continuation handoff](../reproducibility/m2-pause-2026-09-02/README.md).

Authority: the latest human implementation direction, [M1 contracts](m1-contracts.md), [ADR-001](../decisions/ADR-001-parser-technology.md), [roadmap](../roadmap.md), and [semantic evaluation procedure](../../.agents/skills/se-project-engineering/semantic-evaluation.md). Existing M1 identities and validation remain unchanged at pause.
