...
**PROVISIONAL implementation baseline, 2026-09-02; implementation resumed 2026-09-03.** JavaParser + SymbolSolver is human-approved. The human directed Codex to proceed using D1–D3 in production vertical slices. Bounded declarations/calls/explicit-constructor and declared-type slices are implemented; full M2 correctness and G2 remain unproven. The [pause archive](../reproducibility/m2-pause-2026-09-02/README.md) remains immutable historical input; see the [initial implementation evidence](../reproducibility/m2-implementation-2026-09-03/README.md) and [declared-type evidence](../reproducibility/m2-types-2026-09-03/README.md) for tested support.
